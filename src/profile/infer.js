...
const ROLE_RULES = [
  {
    ...
    keywords: [/nanai/i, /agent/i, /llm/i, /prompt/i, /context/i, /memory/i, /codex/i, /claude/i, /openai/i, /minimax/i],
...
function inferProjects(text) {
  const projects = []
  if (/nanai/i.test(text) || /奈奈/.test(text)) projects.push('Bailongma')
